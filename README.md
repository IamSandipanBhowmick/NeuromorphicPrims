...
One prominent researcher working at this intersection is **Dr. Johan Kwisthout**, whose work I have been closely following over the years. During this process, I came across the following remarkable paper:

> Janssen, S., Groenen, S., Reichert, S., & Kwisthout, J. (2024, July).  
> *Solving Minimum Spanning Tree Problem in Spiking Neural Networks: Improved Results.*  
> In **2024 International Conference on Neuromorphic Systems (ICONS)**, pp. 47–54. IEEE.
...
My broader research interest lies in the intersection of **Theoretical Computer Science** and **Neuromorphic Computing**.
...
If you are interested in working on problems related to the intersection of **TCS and Neuromorphic Computing**, feel free to contact me.

Collaborations, suggestions, corrections, and improvements are always welcome.
